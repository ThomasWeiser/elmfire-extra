...
import ElmFire exposing
  ...
  , subscribe, childAdded, childChanged, childRemoved, noOrder
  , sub, push, set, remove)
...
{- Notes
  ...
  - pace-maker / grace period / (how is it called?)
...
subscribeDelta addressee decoder location =
  initSubscriptions addressee decoder location
...
initSubscriptions : Address (Delta v) -> JD.Decoder v -> Location -> Task Error ()
initSubscriptions addressee decoder location =
  let
